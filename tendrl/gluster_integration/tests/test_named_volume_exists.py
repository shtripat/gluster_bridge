...
from tendrl.gluster_integration.objects.volume.atoms import named_volume_exists
from tendrl.gluster_integration.objects.volume import volume


class TestNamedVolumeExists(object):
    def test_run(self, monkeypatch):
        self.obj = named_volume_exists.NamedVolumeExists()
        named_volume_exists.volume.etcd = MagicMock()
        named_volume_exists.volume.TendrlConfig = MagicMock()
